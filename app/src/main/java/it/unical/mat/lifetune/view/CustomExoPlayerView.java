...
public final class CustomExoPlayerView extends FrameLayout {
     ...
     */
    public CustomExoPlayer getPlayer() {
        return player;
    }
     ...
     */
    public void setPlayer(CustomExoPlayer player) {
    ...
    private void setTrackTitle(String title) {
        ...
        TextView mTitle = findViewById(R.id.exo_title);
    ...
    private void setAvatar(String avatarUrl) {
        ImageView mAvatar = findViewById(R.id.exo_avatar);

        int imageSize = (int) getResources().getDimension(R.dimen.music_player_height);
